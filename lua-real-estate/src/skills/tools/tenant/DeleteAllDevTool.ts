...
const COLLECTIONS = ['applications', 'leases', 'viewings', 'maintenance', 'payments'];

export class DeleteAllDevTool implements LuaTool {
  name = 'delete_all_dev';
  description =
    '⚠️ TESTING ONLY: Delete all dynamic data (applications, leases, viewings, maintenance, payments). Use before re-running demos to start fresh.';
